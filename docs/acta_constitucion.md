# 📜 Acta de Constitución del Equipo Scrum — SATE-UNIAJC

> ⚠️ *Nota pedagógica: Los roles asignados a continuación son iniciales para el Sprint 1 y rotarán obligatoriamente a partir del Sprint 3 según el acuerdo del curso.*

* **Nombre del Equipo Scrum:** `CamachoDevs`
* **Proyecto:** SATE-UNIAJC (Sistema de Alertas Tempranas y Acompañamiento Estudiantil)
